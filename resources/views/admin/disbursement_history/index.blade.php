    ...
    <div class="pt-3">
        ...
        <div class="card {{ env('CARD_THEME') }} shadow-custom">
            ...
            <div class="card-body">
                ...
                @if (Auth::user()->hasAnyPermission(['*', 'prefix.all', 'prefix.create']))
                ...
                <table id="table" class="table table-hover dataTable no-footer nowrap" style="width: 100%;">
                    <thead class="bg-custom">
                        <tr>
                            ...
                            <th class="text-center">ชื่อคำนำหน้าชื่อ (ภาษาไทย)</th>
                            <th class="text-center">ชื่อคำนำหน้าชื่อ (ภาษาอังกฤษ)</th>
