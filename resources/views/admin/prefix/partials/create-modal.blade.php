        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">ชื่อคำนำหน้าชื่อ (ภาษาไทย)</label>
                        <input class="form-control form-control-sm" name="name_th" id="name_th" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">ชื่อคำนำหน้าชื่อ (ภาษาอังกฤษ)</label>
                        <input class="form-control form-control-sm" name="name_en" id="name_en" />
                    </div>
                </div>
